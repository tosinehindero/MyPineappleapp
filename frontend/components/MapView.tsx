      ...
      <div className="bg-darkBlue/95 backdrop-blur-md border-b border-gold/20 px-6 py-4 sticky top-0 z-[1001]">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/feed" className="flex items-center space-x-2 group">
            ...
            <img src="https://customer-assets.emergentagent.com/job_ece997f5-18cb-49ee-85d0-980bc524a48f/artifacts/z2y9pjap_1771729561245.png" alt="Pineapple" className="h-8 w-8 object-cover rounded-xl" />
          </Link>

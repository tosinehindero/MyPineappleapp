  ...
  return (
    ...
    <div className="min-h-screen bg-charcoal">
        ...
        <div className="flex flex-wrap gap-2">
          {CATEGORIES.map((category) => (
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-body transition-all ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2">
        <div className="bg-green-500/10 border border-green-500/30 rounded-xl px-3 sm:px-4 py-3 flex items-center space-x-3">
          <div className="w-8 sm:w-10 h-8 sm:h-10 bg-green-500/20 rounded-full flex items-center justify-center flex-shrink-0">
            <svg className="w-4 sm:w-5 h-4 sm:h-5 text-green-400" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
              <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          </div>
          <div>
            <p className="text-green-400 font-body text-xs sm:text-sm font-medium">Secure Escrow Protection</p>
